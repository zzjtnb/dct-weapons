...
local num_squad = 0
local function next_squad()
    num_squad = num_squad + 1
    return num_squad
end

local first_sq = require('descent_two_squad_on_bmd')
local second_sq = require('descent_two_squad_on_tiger')
local third_sq = require('descent_one_platoon_task_1')
local fourth_sq = require('descent_one_platoon_task_2')

order_data = {
    first_sq.TrooperGroups (next_squad(), country.id.RUSSIA),
    second_sq.TrooperGroups(next_squad(), country.id.RUSSIA),
    third_sq.TrooperGroups (next_squad(), country.id.RUSSIA),
    fourth_sq.TrooperGroups(next_squad(), country.id.RUSSIA)
}
