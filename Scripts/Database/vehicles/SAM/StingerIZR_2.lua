...
GT.visual.shape = "Stinger_com2";
GT.visual.shape_dstr = "Stinger_com2_d";
...
GT.Name = "Stinger comm dsr";
GT.DisplayName = _("SAM Stinger comm dsr");
GT.Rate = 5;

GT.DetectionRange  = GT.sensor.max_range_finding_target;
GT.ThreatRange = 0;
GT.mapclasskey = "P0091000201";
GT.attribute = {wsType_Ground,wsType_SAM,wsType_Miss,StingerIZR_2,
				"MANPADS AUX",
				"CustomAimPoint",
				};
