-- S-300 CCP 54K6 based on MAZ-543
...
for i = 1,15 do
    ...
    GT.WS[ws].LN[1].depends_on_unit = {{{"S-300PS 40B6MD sr",},},{{"S-300PS 64H6E sr",},},};
end

GT.Name = "S-300PS 54K6 cp"
GT.DisplayName = _("SAM SA-10 S-300PS CP 54K6")
GT.Rate = 20
