...
GT.chassis.life = 1; -- shielded

GT.visual.shape = "ZU-23";
GT.visual.shape_dstr = "ZU-23_P1";
...
GT.Name = "ZU-23 Emplacement Closed";
GT.DisplayName = _("AAA ZU-23 Emplacement Closed");
GT.Rate = 3;
...
GT.attribute = {wsType_Ground,wsType_SAM,wsType_Gun,ZU_23_OKOP,
                "AA_flak",
                "Static AAA",
                };
