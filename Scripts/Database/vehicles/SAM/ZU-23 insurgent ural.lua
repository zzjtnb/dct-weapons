...
GT.visual.shape = "Ural_ZU-23_CHECH";
...
GT.Name = "Ural-375 ZU-23 Insurgent";
GT.DisplayName = _("AAA ZU-23 Insurgent on Ural-375");
GT.Rate = 6;

GT.DetectionRange  = GT.sensor.max_range_finding_target;
GT.ThreatRange = GT.WS[1].LN[1].distanceMax;
GT.mapclasskey = "P0091000205";
GT.attribute = {wsType_Ground,wsType_SAM,wsType_Gun,ZU_23_insurgent_ural,
                "AA_flak",
                "Mobile AAA",
                };
