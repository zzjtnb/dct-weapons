...
GT.WS[ws].LN[1].PL[1].type_ammunition = {wsType_Weapon, wsType_NURS, wsType_Rocket, SMERCH_9M55K}
GT.WS[ws].LN[1].PL[1].rocket_name = "weapons.nurs.SMERCH_9M55K";
...
GT.Name = "Smerch";
GT.DisplayName = _("MLRS 9A52 Smerch");
GT.Rate = 20;
