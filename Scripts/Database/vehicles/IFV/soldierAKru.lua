...
GT.visual.shape = "soldier_ru_00";
GT.visual.shape_dstr = "soldier_ru_00_d";
...
GT.WS[ws].pos = {0,1,0};
GT.WS[ws].angles = {
                    {math.rad(45), math.rad(-45), math.rad(-60), math.rad(60)},
                    };
...
__LN.BR[1].recoilArgument = 13;
__LN.BR[1].recoilTime = 0.1;
__LN.connectorFire = false;

GT.Name = "Infantry AK";
GT.DisplayName = _("Infantry Soldier Rus");
GT.Rate = 1;
