...
GT.chassis.armour_thickness = 0.2
GT.chassis.life = 50

GT.visual.shape = "dot2"
GT.visual.shape_dstr = "DOT2destr"
...
__LN_PK = {}; -- ПКC с патроном 7.62x54
...
GT.WS[ws].angles = {
					{math.rad(-20), math.rad(-160), math.rad(-15), math.rad(15)},
					};
...
GT.WS[ws].angles = {
					{math.rad(160), math.rad(20), math.rad(-15), math.rad(15)},
					};
GT.WS[ws].reference_angle_Y = math.rad(90);
