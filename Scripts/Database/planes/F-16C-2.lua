return plane( "F-16C bl.52d", _("F-16C bl.52d"),
    {
    ...
    },
    {
        ...
        aim9_station(3, 0, -1.115000, -0.161000, -3.050000,
            ...
            },
            {
				...
				{ CLSID = "{9BCC2A2B-5708-4860-B1F1-053A18442067}", Type = 1 }, -- AGM-154
        ...
        pylon(4, 0, -0.118000, -0.175000, -1.813000,
            ...
            },
            {
                ...
                { CLSID = "{9BCC2A2B-5708-4860-B1F1-053A18442067}", Type = 1 },	--AGM-154C
                { CLSID = "{51F9AAE5-964F-4D21-83FB-502E3BFE5F8A}" },
                { CLSID = "{DB769D48-67D7-42ED-A2BE-108D566C8B1E}" },
                { CLSID = "{AB8B8299-F1CC-4359-89B5-2172E0CF4A5A}" },
                { CLSID = "{BCE4E030-38E9-423E-98ED-24BE3DA87C32}" },
